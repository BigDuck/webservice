 ...
 * generated in the spring.dao package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://dao.spring/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://dao.spring/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: spring.dao
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.spring/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.spring/", name = "getOrderByIdResponse")
